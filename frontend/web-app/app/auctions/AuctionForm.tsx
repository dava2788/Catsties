    ...
    <form className=' flex flex-col mt-3' onSubmit={handleSubmit(onSubmit)}>
        ...
        {pathname === '/auctions/create' && 
            <>
                ...
                <div className=' grid grid-cols-2 gap-3'>
                    <Input label='Reserve Price (Enter 0 if no reserve)' name='reserPrice' control={control}  rules={{required: 'Reserve Price is required'}} type='number'/>
        ...
        <div className=' flex justify-between'>
            ...
            <Button isProcessing={isSubmitting} disabled={!isValid}  type='submit' outline color='gray'>Submit</Button>
        </div>
