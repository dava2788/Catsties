...
public class AuctionControllerTests
{
    ...
    public AuctionControllerTests()
    {
        ...
        {
            //Add the mappings for all the auctionProject
    ...
    public async Task GetAuctionById_WithValidGuid_ReturnsAuction()
    {
        ...
        var returnResult = ((ObjectResult)result.Result).Value as AuctionDto ;

        // assert
        //Compare the actionDto Make to the result
        Assert.Equal(auction.Make, returnResult.Make);
    ...
    public async Task CreateAuction_WithValidCreateAuctionDto_ReturnsCreatedAtAction()
    {
        ...
        //Not return because the method is void
