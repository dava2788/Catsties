...
{
    //For used the test Service we prepared
    private readonly CustomWebAppFactory _factory;
    //To call the endPoints
    private readonly HttpClient _httpClient;
    //Guid for making test and get Auction by ID
    ...
    public async Task GetAuctionById_WithInvalidGuid_ShouldReturn400()
    {
        ...
        // act
        //Test with Not a Guid Parameter
    ...
    //Not need to do anything with the Initialize
    public Task InitializeAsync() => Task.CompletedTask;

    //to re initialize our database after every test.
    public Task DisposeAsync()
    {
        // give us access to the scope that the test is running 
        using var scope = _factory.Services.CreateScope();
        //For use the context and Reinit
